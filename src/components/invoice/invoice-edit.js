...
import invoiceInitialValues from "./invoice-initial-value.json";
                ...
                onClick={() => {
                  ...
                  if (isProduct) {
                    ...
                    setFieldValue(
                      ...
                      calculateSubtotal(price, currentQuantity)
                    );
                  }
                }}
              >
              ...
              <Row className="mb-3">
                ...
                <Col md={4}>
                  <Form.Group>
                    ...
                    <Field name="invoiceDate" type="date" as={Form.Control} />
                    <ErrorMessage
                      name="invoiceDate"
                      component="div"
                ...
                <Col md={4}>
                  <Form.Group>
                    ...
                    >
                      ...
                      <option value="Annulation de facture">
                      ...
                      <Row key={index} className="mb-3 align-items-center">
                        ...
                        <Col md={2}>
                          <Form.Group>
                            ...
                            <p className="price-text">{`${
                              typeof accessoire.subtotal === "number"
                                ? accessoire.subtotal.toFixed(2)
                                : "0.00"
                            } €`}</p>
                          </Form.Group>
                        </Col>
                        ...
                        <Col md={1}>
                          <Form.Group>
                            ...
                            <Field
                              as="select"
                              name={`accessoires[${index}].taxRate`}
                              className="form-control"
                              onChange={(e) => {
                                const newTaxRate =
                                  parseInt(e.target.value, 10) || 0;
                            ...
                            <InputGroup>
                              <Field
                                ...
                                onChange={(e) => {
                                  ...
                                  setFieldValue(
                                    `items[${index}].subtotal`,
                                    calculateSubtotal(item.price, quantity)
                                  );
                                }}
                              />
                              <ErrorMessage
